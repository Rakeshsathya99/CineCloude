...
const MovieDetails = () => {
  ...
  const { shows, axios, getToken, user, fetchFavoriteMovies, 
    favoriteMovies, image_base_url} = useAppContext()
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p className='text-gray-400 mt-text-sm leasding-tight max-w-xl'>{show.movie.overview}</p>
        
          <p>
            {timeFormate(show.movie.runtime)} . {show.movie.genres.map(genre =>
              genre.name).join(", ")} . {show.movie.release_date.split("-")[0]}
          </p>
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            <button onClick={() => toast('Trailer not available yet')} className='flex items-center gap-2 px-7 py-3 text-sm
            ...
            hover:bg-primary-dull tranisition rounded-md font-medium cursor-pointer
      ...
      <p className='text-lg font-medium mt-20'>You're Favorite cast</p>
        ...
        <div className="flex items-center gap-4 w-max px-4">
          ...
          <div className="flex flex-wrap max-sm:justify-center gap-8">
            ...
            <div className="flex justify-center mt-20">
              ...
              transition rounded-md font-medium cursor-pointer'>Show More
              </button>
            </div>
    </div>
  ): <Loading/>
