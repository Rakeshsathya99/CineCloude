          ...
          duration-300`}
            ...
            >
              ...
              p-2 bg-black/70 w-full absolute bottom-0 left-0"
                ...
                text-gray-400"
                  >
                    <StarIcon className="w-4 h-4 text-primary fill-primary-400" />
...
cursor-pointer"
      ...
      <button className='bg-primary text-white px-6 py-3 mt-10 rounded hover:bg-primary/90 transition-all cursor-pointer'>
      Add Show
      </button>
    </>
  ) : (
