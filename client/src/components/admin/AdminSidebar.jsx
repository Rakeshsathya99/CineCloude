...
const AdminSidebar =()=> {
  ...
  return (
    <div className= 'h-[calc(100vh-64px0] md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-gray-300/20 text-sm'>
        ...
        <div className='w-full'>
            {adminNavLinks.map((link, index) =>(
                ...
                `relative flex items-center max-md:justify-ceneter gap-2 w-full py-2.5 
